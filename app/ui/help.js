...
(function () {
  ...
  const TEMPLATE = [
    ...
    '<ol class="help-steps">',
    '<li><b>起名</b>：进「数据库」页，点左上「新建表格」，给表起个名，如"费用明细"。</li>',
    '<li><b>加列</b>：列就是表头那一列。想清楚要记哪几项，逐个加上（如：项目、金额、日期）。</li>',
    '<li><b>录数据</b>：建好后切到「数据」页签，滚到表尾那一行直接填，按回车就提交。</li>',
    '</ol>',
    '<p>不会填？点数据库页左上「创建示例台账」，一张现成的表立刻打开给你看。</p>',

    // ③ 列类型怎么选
    '<h4 class="help-h">三、列类型（先不用管）</h4>',
    '<p><b>新建表格时不用挑类型</b> —— 默认按文本存，什么内容都能装，先记起来再说。' +
      '金额、日期这类想让它按"数字 / 日期"来排序和计算时，再回新建对话框里改（共 9 种）。</p>',
    ...
    '<tr><td>某一行点不动、改不了</td><td>这张表没有"主键"列，系统分不清第几行</td><td>新建表格时给一列打上「主键」就能改</td></tr>',
    '<tr><td>表打不开</td><td>可能损坏，或被别的程序占用</td><td>点「刷新」；还不行就重启程序</td></tr>',
    '</tbody></table>',

    // ⑦ 术语表
    '<h4 class="help-h">七、术语对照</h4>',
    '<table class="help-table">',
